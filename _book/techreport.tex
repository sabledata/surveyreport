...
\caption{Average weight of sablefish per trap (kg/trap) (A); average number of sablefish per trap (\#fish/trap) (B); annual average weight of sablefish (kg) (C) by offshore survey strata over time. Horizontal line is median and blue dots are arithmetic mean.}\label{fig:figure9}
\end{figure}
\clearpage
