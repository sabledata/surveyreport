...
Catch per unit effort (CPUE) is an important product from this survey. They can be used to infer population trends which are critical data elements used in stock assessment. CPUE from stratified random sets in the shallow depth stratum have shown a gradual decline in kilograms per trap from 2004 to 2007. CPUE rose again 2008 through 2010 and gradually declined from 2011 through 2014 to levels seen in 2007. An increase occurred again in 2015 through 2017, similar to those in 2008 and 2010. Last, CPUE surged in 2018, and 2019 to historic levels.
...
Across all years the highest annual CPUE (kg/trap) typically occured in the middle depths (450-850 m). In recent years, an increase in CPUE started in 2015 and a rapid rise in CPUE began in 2017 (Figure~\ref{fig:figure5}). This increase occurred in most depth strata (RD\textsubscript{1} to RD\textsubscript{2}) and area strata (SD\textsubscript{1} to SD\textsubscript{5}) (Figure~\ref{fig:figure6}).

There is a significant increase in the CPUE (\#fish/trap) and variability (+-95\% CI) in the past couple years in the mid depth stratum across all area strata SD\textsubscript{1} to SD\textsubscript{5} (Figure~\ref{fig:figure7}).

In contrast, the average weight of sablefish in the mid-depth waters and all strata have decreased (Figure~\ref{fig:figure8}).
