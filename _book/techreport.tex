...
\begin{tabular}[t]{>{\raggedright\arraybackslash}p{6.4cm}>{\raggedleft\arraybackslash}p{1.9cm}>{\raggedleft\arraybackslash}p{1.7cm}>{\raggedleft\arraybackslash}p{1.7cm}>{\raggedleft\arraybackslash}p{0.5cm}}
\toprule
