...
\newcommand{\trAuthsBack}{Lacko, L.C., Acheson, S.M. and Connors, B.M.}
...
\newcommand{\trISBN}{978-0-660-35792-8}
...
Co-plots of average temperatures and average depths by 1-degree latitude intervals from south-west Vancouver Island to northwest Haida Gwaii exhibit a general trend of decreasing temperature with depth for 2018 and 2019 (Figure~\ref{fig:figure15}).
...
{\centering \pdftooltip{\includegraphics[width=450px,height=530px]{C:/github/surveyreport/figures/Figure1}}{Figure \ref{fig:figure1}} 
