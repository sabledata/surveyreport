...
Across all years the highest annual CPUE (kg/trap) typically occured in the middle depths, with a rapid rise starting in 2017 (Figure~\ref{fig:figure5}). In recent years, an increase in CPUE (kg/trap) occurred in the deep depth stratum (RD\textsubscript{3}) in area strata SD\textsubscript{1}, SD\textsubscript{2}, SD\textsubscript{3} and SD\textsubscript{5}; in the middle depth stratum (RD\textsubscript{2}) across all area strata (SD\textsubscript{1}) to (SD\textsubscript{5}) ; and in the shallow depth stratum (RD\textsubscript{1}) in SD\textsubscript{1} and SD\textsubscript{5} (Figure~\ref{fig:figure6}). There is a significant increase in the cpue (\#fish/trap) and variability (+-95\% CI) in recent years in the mid depth stratum across all area strata SD\textsubscript{1} to SD\textsubscript{5} (Figure~\ref{fig:figure7}). In contrast, the average weight of sablefish in the mid-depth waters and all strata have decreased (Figure~\ref{fig:figure8}).

\hypertarget{mainland-inlet-cpue}{%
\subsubsection{Mainland Inlet CPUE}\label{mainland-inlet-cpue}}

CPUE (kg/trap and \#fish/trap) in the mainlaind inlets have varied in a predictable manner over time with peak CPUE occuring every 5-8 years (Figure~\ref{fig:figure9} a,b). In 2018 and 2019, the trend has increased to record levels. In contrast, the average weight of sablefish in 2018 and 2019 have show record lows (Figure~\ref{fig:figure9} c).
...
{\centering \pdftooltip{\includegraphics[width=450px,height=550px]{C:/github/surveyreport/figures/Figure_1_Report_Overview_survey_2019}}{Figure \ref{fig:figure1}} 
...
{\centering \pdftooltip{\includegraphics[width=450px,height=550px]{C:/github/surveyreport/figures/Figure_3_Report_Inlets_2019_2}}{Figure \ref{fig:figure3}} 
...
{\centering \pdftooltip{\includegraphics[width=6in]{C:/github/surveyreport/figures/Figure_7_CPUE}}{Figure \ref{fig:figure7}} 
...
{\centering \pdftooltip{\includegraphics[width=6in]{C:/github/surveyreport/figures/Figure_8_}}{Figure \ref{fig:figure8}} 
...
{\centering \pdftooltip{\includegraphics[width=450px,height=560px]{C:/github/surveyreport/figures/Figure_9_InletCPUE}}{Figure \ref{fig:figure9}} 
...
{\centering \pdftooltip{\includegraphics[width=450px,height=550px]{C:/github/surveyreport/figures/Figure_10_lengths}}{Figure \ref{fig:figure10}} 
...
{\centering \pdftooltip{\includegraphics[width=450px,height=550px]{C:/github/surveyreport/figures/Figure_11_Lenwt}}{Figure \ref{fig:figure11}} 
...
{\centering \pdftooltip{\includegraphics[width=450px,height=570px]{C:/github/surveyreport/figures/Figure_13_ages}}{Figure \ref{fig:figure13}} 
