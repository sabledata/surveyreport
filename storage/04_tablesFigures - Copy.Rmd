...
(ref:figure4) Image of F/V Ocean Pearl and F/V Pacific Viking (bottom).  Photo credit: Joe Smith.

```{r figure4, fig.cap='(ref:figure4)', echo=FALSE, out.width = "350px",out.height = "600px", fig.align="center", warning=FALSE}
      img <- paste('C:/github/surveyreport/figures/Figure_2_vessels.png'  ,sep="")
      knitr::include_graphics(img)
```
\clearpage

(ref:figure5) Top: Trap elements.  Bottom:  Trap gear elements consisting of 25 baited traps snapped to beckets along a groundline.
...
(ref:figure6) Distribution of yearly catch rates for StRS sets summarised by a boxplot. Each panel shows catch rates grouped by depth strata from shallow to deep (RD~1~-RD~3~) for each year of the StRS survey.  The red circles show the mean catch rates for each depth stratum.
