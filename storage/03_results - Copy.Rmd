...
Of the 91 randomly generated blocks for the StRS portion of the survey, x blocks were not fished due to distance for planning purposes and replaced, x of the regenerated blocks were rejected due to planning and replaced with new ones.
...
Of the 91 original blocks for the StRS portion of the survey, 3 blocks were replaced due to skipper knowledge, one block was not fished due to distance for planning purposes, four of the regenerated blocks were rejected due to planning and replaced with new ones. 
...
Figure \@ref(fig:figure8) (bottom) graphs the average length of male and female sablefish by year.  In `r yr`, the average mean fork length for the `r format(length(firstyrfem$sex), big.mark=",")` females was `r round(favgyr1$AvL,1)` cm  and the average mean fork length for the `r format(length(firstyrmal$sex), big.mark=",")` males was `r round(mavgyr1$AvL,1) ` cm. In `r yr+1`, the average mean fork length for the `r format(length(secondyrfem$sex), big.mark=",")` females was `r round(favgyr2$AvL,1)` cm and the average mean fork length for the `r format(length(secondyrmal$sex), big.mark=",")` males was `r round(mavgyr2$AvL,1)` cm.

The length (cm) weight (kg) relationships for male and female sablefish are shown by the `r yr` survey year (Figure \@ref(fig:figure9), left) and the `r yr+1` survey year (Figure \@ref(fig:figure9), right).   Female sablefish grow faster and reach far greater size and weight compared to males.

## SABLEFISH SUB-LEGAL ENCOUNTERS

The percentage of sub-legal sablefish (<55 cm fork length) sampled in each the StRS strata are shown in Figure \@ref(fig:figure10) since the the winter of 2013-14, when a warm body of water dubbed “The Blob” was detected [@Bond2015].  More than half of the specimens that were sub-legal were found in the southern strata (S~1~) mid-depth waters (RD~2~) in 2014 and  shallow waters (RD~1~) in 2015.  The sub-legal specimen count was above 50% in both 2017 and 2018 in the northern strata of S~4~ and S~5~  mid-depth waters (RD~2~).  In 2019, the sub-legal specimens dominated with over 50% found in all StRS survey strata (S~1~ to S~5~) mid-depth waters (RD~2~). 

## OTHER FISH SAMPLING

The biological data collected during the `r yr` and `r yr+1` surveys from species other than sablefish are listed in Appendix I and Appendix J, respectively.  Length, sex, maturity, otoliths and DNA samples were taken for `r otherfish[1,2]` (`r yr`) and `r otherfish2[2,2]` (`r yr+1`) specimens of the Rougheye/Blackspotted Rockfish complex.  Length, sex, maturity, otoliths were taken for `r otherfish[2,2]` (`r yr`) and `r otherfish2[3,2]` (`r yr+1`) Shortraker Rockfish.  In addition, length, sex, maturity, otoliths were taken for `r otherfish[3,2]` (`r yr`) and `r otherfish2[4,2]` (`r yr+1`)  Yelloweye Rockfish.  

For Pacific Halibut, only length samples were performed on `r otherfish[1,2]` (`r yr`) and `r otherfish2[5,2]` (`r yr+1`) specimens.  Last, a length sample was taken for `r otherfish2[1,2]` (`r yr+1`) Pacific Sleeper shark.
...
Co-plots of average temperatures and average depths by 1-degree latitude intervals from south-west Vancouver Island to northwest Haida Gwaii are shown for `r yr` and `r yr+1` in Figure \@ref(fig:figure12). Although the number of sets that deployed Sea-bird SBE 39 loggers varied in each 1-degree latitude zone, the general trend shows that the average temperatures decrease with increased depth.   
