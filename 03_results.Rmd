...
```{r SpeciesCompositionYear2, echo=FALSE}
   ...
   topStRSsp.2   <-  read.csv("c:/github/surveyreport/standaloneData/topspcomp2.csv",header=T)  
  ...
  # topInletsp.2   <- GetSQLData(topInlet.2,"Sablefish")  
   topInletsp.2   <-  read.csv("c:/github/surveyreport/standaloneData/topspcompINLET2.csv",header=T)
 ...
 # -- species composition counts for StRS sets
   ...
   strsSpCom.2   <-  read.csv("c:/github/surveyreport/standaloneData/topspcompSTRS2.csv",header=T) 
  ...
  # -- species composition counts inlet sets
   spc.2          <- paste("select dbo.fnIntegerToWords(SUM(CAST(Roundfish AS int))) AS tRound,   ",
                         ...
                         "from   (select CASE WHEN Fish = Rockfish or Fish = Flatfish THEN 0 ELSE Fish END AS Roundfish,  ",
                                 ...
                                 "and (Year = ",yr+1,")) AS RC",sep="")
   #strsSpCom.2    <- GetSQLData(spc.2,"Sablefish")
   strsSpCom.2   <-  read.csv("c:/github/surveyreport/standaloneData/topspcompINLET2.csv",header=T) 
...
```{r SamplingWords, echo=FALSE}
    ...
    countStRS   <-  read.csv("c:/github/surveyreport/standaloneData/countingStRS.csv",header=T) 
    ...
    countStRS2   <-  read.csv("c:/github/surveyreport/standaloneData/countingStRS2.csv",header=T) 
      ...
      lendata   <-    read.csv("c:/github/surveyreport/standaloneData/lengthData.csv",header=T) 
      ...
      biosumm   <-    read.csv("c:/github/surveyreport/standaloneData/biosum.csv",header=T) 
      ...
      #  -- sum the count of length values 
      ...
      biosumm2.2   <-    read.csv("c:/github/surveyreport/standaloneData/biosumInlet2.csv",header=T)
