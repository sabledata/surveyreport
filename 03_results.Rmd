...
CPUE in the mainlaind inlets has varied in a relatively predictable manner over time with peak CPUE occuring every 5-8 years (Figure \@ref(fig:figure10)a, b). In the early part of the time series (mid-1990s) average CPUE remained relatively constant before a peak in CPUE was observed in 1999, followed by declines to conistent levels until another peak in 2003 and 2004, and again in 2011.  In 2018, CPUE returned (~`r data18.mn` fish, and ~X kg, per trap) to the levels observed during previous peaks. In 2019, the highest catches rates of the 26 year time series were observed (~35 fish, and ~`r data18kg.mn` kg, per trap).
...
Co-plots of average temperatures and average depths by 1-degree latitude intervals from south-west Vancouver Island to northwest Haida Gwaii can be found in Figure \@ref(fig:figure15).  The `r yr` and `r yr+1` survey data exhibit a general trend of decreasing temperature with depth. 
