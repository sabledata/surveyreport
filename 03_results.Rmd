...
```{r CatchRateText, echo=FALSE}
  ...
  datStRS  <-  read.csv("c:/github/surveyreport/standaloneData/generictraps.csv",header=T) 
...
```
## CATCH RATES
The annual catch rates (number of Sablefish/number of traps) for StRS sets are summarized with boxplots in Figure \@ref(fig:figure5) for each depth stratum (RD~1~-RD~3~) since the stratified random sampling program began in 2003. 
...
```{r SpeciesCompositionText, echo=FALSE}
  # -- taxonomic group count StRS year one
   ...
   topStRSsp  <-  read.csv("c:/github/surveyreport/standaloneData/taxgroup.csv",header=T) 
  ...
  # -- taxonomic group count Inlets 
   ...
   topInletsp   <-  read.csv("c:/github/surveyreport/standaloneData/taxgroupInlets.csv",header=T)    
 ...
 # -- species composition counts for StRS sets
   ...
   strsSpCom   <-  read.csv("c:/github/surveyreport/standaloneData/spcompStRS.csv",header=T) 
  ...
  # -- species composition counts inlet sets
   ...
   strsSpComI   <-  read.csv("c:/github/surveyreport/standaloneData/spcompInlet.csv",header=T) 
...
```{r SpeciesCompositionYear2, echo=FALSE}
   ...
   #csv topStRSsp.2   <-  read.csv("c:/github/surveyreport/standaloneData/topspcomp2.csv",header=T)  
  ...
  # -- taxonomic group count Inlets 
   ...
   #csv topInletsp.2   <-  read.csv("c:/github/surveyreport/standaloneData/topspcompINLET2.csv",header=T)
 ...
 # -- species composition counts for StRS sets
   ...
   #csv strsSpCom.2   <-  read.csv("c:/github/surveyreport/standaloneData/topspcompSTRS2.csv",header=T) 
  ...
  # -- species composition counts inlet sets
   ...
   #csv strsSpComI.2   <-  read.csv("c:/github/surveyreport/standaloneData/topspcompINLET2.csv",header=T) 
...
```{r SamplingWords, echo=FALSE}
    ...
    #csv countStRS   <-  read.csv("c:/github/surveyreport/standaloneData/countingStRS.csv",header=T) 
    ...
    #csv countStRS2   <-  read.csv("c:/github/surveyreport/standaloneData/countingStRS2.csv",header=T) 
      ...
      #csv lendata   <-    read.csv("c:/github/surveyreport/standaloneData/lengthData.csv",header=T) 
      ...
      #csv biosumm   <-    read.csv("c:/github/surveyreport/standaloneData/biosum.csv",header=T) 
      ...
      if (pS1 == 1)  {wS1="S1, "} else {wS1=""} # --  if value negative, more females
      ...
      biosumm.2   <-    read.csv("c:/github/surveyreport/standaloneData/biosum2.csv",header=T) 
      ...
      biosumm2   <-    read.csv("c:/github/surveyreport/standaloneData/biosumInlet.csv",header=T)
      ...
      #csv biosumm2.2   <-    read.csv("c:/github/surveyreport/standaloneData/biosumInlet2.csv",header=T)
...
```{r SablefishAgesText, echo=FALSE}
   ...
   agedat      <-    read.csv("c:/github/surveyreport/standaloneData/sableages.csv",header=T)
   
   oldageF     <-  "exec procRReport_Survey_oldAgeFish 2"  # -- oldest female text caption
   #oldageFem   <-  GetSQLData(oldageF,"Sablefish") 
   oldageFem    <-    read.csv("c:/github/surveyreport/standaloneData/oldageFem.csv",header=T)
   
   oldageM     <-  "exec procRReport_Survey_oldAgeFish 1"  # -- oldest male text caption
   #oldageMale  <-  GetSQLData(oldageM,"Sablefish") 
   oldageMale  <-    read.csv("c:/github/surveyreport/standaloneData/oldageMale.csv",header=T)   
