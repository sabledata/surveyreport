...
### Mainland Inlets
Figure \@ref(fig:figure7) shows the catch rates forof standardized sets conducted at mainland inlet localities from 1994 through to `r yr`.  The mean catch rates remained consistent in the mid1990s, from 1994 through 1997 (~8 to 10 fish per trap) and  increased in 1998 (~15 fish per trap) and again in 1999 (~23 fish per trap).   Catch rates from 2000 through 2002 (~8 to 11 fish per trap) returned to levels seen in the mid-1990s.   High catch rates (~20 and 21 fish per trap, respectively) appear in 2003 and 2004.  A steadily decline began in 2005 through 2008 (from ~14 down to 5 fish per trap). During 2009 through 2011, a steady increase in catch rates occurred, with the 2010 catch rate (~15 fish per trap) being similar to that in 1998, and the 2011 catch rate (~22 fish per trap) being similar to that in 1999.  A decrease in catch rates was seen in 2012 (~ 13 fish per trap).


Figure \@ref(fig:figure7) illustrates the steady increase and decrease in catch rates at mainland inlet locations.  The mean catch rates remained consistent in the mid1990s, from 1994 through 1997 (~8 to 10 fish per trap) and increased in 1998 (~15 fish per trap) and again in 1999 (~23 fish per trap).   Catch rates from 2000 through 2002 (~8 to 11 fish per trap) returned to levels seen in the mid-1990s.   High catch rates (~20 and 21 fish per trap, respectively) appeared again in 2003 and 2004.

  A steadily decline began in 2005 through 2008 (from ~14 down to 5 fish per trap.  During 2009 through 2011, a steady increase in catch rates occurred, with the 2010 catch rate (~15 fish per trap) being similar to that in 1998, and the 2011 catch rate (~22 fish per trap) being similar to that in 1999.  Again, a steady decrease in catch rates was seen over the years 2012 through 2015 (from ~13 to 5 fish per trap).  Last, a steady increase was seen again from 2016 through 2019 (~9 to 36 fish per trap).
...
Figure \@ref(fig:figure8) (top) shows the length frequency histograms for the `r tf2` female and  `r tm2` male sablefish sampled for length and sex during the StRS portion of the 2003 - `r yr+1`  surveys.  Out of the `r tf2 + nosex2 + tm2` sablefish sampled for length and sex, `r nosex2` were looked at but no sex could be determined. The mean fork length ($\bar{x}$) for females was `r mLf2` cm and the mean fork length ($\bar{x}$) for males was `r mLm2` cm. 

Figure \@ref(fig:figure8) (bottom) graphs the average length of male and female sablefish by year.  In `r yr`, the average mean fork length for the `r length(firstyrfem$sex)` females was `r round(favgyr1$AvL,1)` cm  and the average mean fork length for the `r length(firstyrmal$sex)` males was `r round(mavgyr1$AvL,1) ` cm. In `r yr+1`, the average mean fork length for the `r length(secondyrfem$sex)` females was `r round(favgyr2$AvL,1)` cm and the average mean fork length for the `r length(secondyrmal$sex)` males was `r round(mavgyr2$AvL,1)` cm.
