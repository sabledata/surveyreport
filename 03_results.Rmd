...
Co-plots of average temperatures and average depths by 1-degree latitude intervals from south-west Vancouver Island to northwest Haida Gwaii are displayed in Figure \@ref(fig:figure14).  The `r yr` and `r yr+1` survey data exhibit a general trend of decreasing temperature with depth. 
