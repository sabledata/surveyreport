...
author: |
  Lacko. C. Lisa^1^ and
  Schon B. Acheson^1^ and
  Brendan M. Connors^1^
author_list: "Lacko, L.C. and Acheson, S.B. and Connors, B.M."
...
```{r SurveyDetails, echo=FALSE}  
   ...
   avgTen      <- read.csv("c:/github/surveyreport/standaloneData/avgcatch.csv",header=T)
   ...
   trapP      <- read.csv("c:/github/surveyreport/standaloneData/trapratio.csv",header=T)
   ...
   LonglineP   <- read.csv("c:/github/surveyreport/standaloneData/llratio.csv",header=T)
   ...
   trapP2      <- read.csv("c:/github/surveyreport/standaloneData/trapratio2.csv",header=T)
   ...
   LonglineP2  <- read.csv("c:/github/surveyreport/standaloneData/llratio2.csv",header=T)
