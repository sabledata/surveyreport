...
#   results='asis',echo=FALSE,include=FALSE,warning=FALSE,message = FALSE,error= FALSE
    png("C:/github/surveyreport/figures/Figure_5_cpuedepth.png", width = 448, height = 628)  # write png to folder 
...
```{r figure9, fig.cap='(ref:figure9)', results='asis', out.width = "450px",out.height = "200px", fig.align="center"}

  png("C:/github/surveyreport/figures/Figure_9_YearStRSCPUE.png", width=600, height=300) # write png to file
