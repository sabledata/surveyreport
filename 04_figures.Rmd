...
```{r figure1, fig.cap='(ref:figure1)', out.width = "450px", out.height = "510px", fig.align="center", warning=FALSE, echo=FALSE, message=FALSE, error=FALSE}
...
#   results='asis',echo=FALSE,include=FALSE,warning=FALSE,message = FALSE,error= FALSE
    png("C:/github/surveyreport/figures/Figure_5_cpuedepth.png", width = 448, height = 648)  # write png to folder 
...
#   query----------raw survey datafile for Landmark fisheries----------------
    ...
    landmrk <- paste("select FishingEventCatchCPUE.TRIP_ID, FishingEventCatchCPUE.VESSEL_ID, FishingEventCatchCPUE.SUFFIX, ",                             "FishingEventCatchCPUE.CAPTAIN_ID, FishingEventCatchCPUE.FISHING_EVENT_ID, FishingEventCatchCPUE.FE_MAJOR_LEVEL_ID,",
               ...
               "dbo.GFBIO_RESEARCH_SAMPLE_DETAILS.[Male Mean Fork Len(mm)],dbo.GFBIO_RESEARCH_SAMPLE_DETAILS.[Female Mean Fork Len(mm)], ",                "dbo.GFBIO_RESEARCH_SAMPLE_DETAILS.[Tagged Mean Fork Len(mm)]  ",
    ...
    strs.02<-arrange(transform(strs01[strs01$SET_YEAR>2003,],SET_YEAR=factor(SET_YEAR,levels=c(2004,2008,2012,2016,
                                                                                          2005,2009,2013,2017,
                                                                                          2006,2010,2014,2018,
    ...
    # this is extra code for describing the cpue by year in the ABSTRACT
    strsRD1 <- strs01[strs01$DepthStrataID == "RD1",]                      
    boxRD1 <-  arrange(transform(strsRD1[strsRD1$SET_YEAR>2014,],SET_YEAR=factor(SET_YEAR,levels=c(2015,2016,2017,
                                                                                         2018,2019))),SET_YEAR)
    strsRD2 <- strs01[strs01$DepthStrataID == "RD2",]                      
    boxRD2 <-  arrange(transform(strsRD2[strsRD2$SET_YEAR>2014,],SET_YEAR=factor(SET_YEAR,levels=c(2015,2016,2017,
                                                                                         2018,2019))),SET_YEAR)
    strsRD3 <- strs01[strs01$DepthStrataID == "RD3",]                      
    boxRD3 <-  arrange(transform(strsRD3[strsRD3$SET_YEAR>2014,],SET_YEAR=factor(SET_YEAR,levels=c(2015,2016,2017,
                                                                                         2018,2019))),SET_YEAR)
    pRD1 <- ggplot(boxRD1, aes(x=SET_YEAR, y=sable_cpue)) + 
          geom_boxplot() +
          xlab("Year") +      ylab("CPUE (kg/trap)") +
          scale_y_continuous(limits=c(0,90))+
          theme(axis.text = element_text(size = 4)) +   theme_bw()
    pRD1c<- ggplot(boxRD1, aes(x=SET_YEAR, y=sable_cnts)) + 
          geom_boxplot() +
          xlab("Year") +      ylab("CPUE (#/trap)") +
          scale_y_continuous(limits=c(0,60))+
          theme(axis.text = element_text(size = 4)) +   theme_bw()
    pRD1wt<- ggplot(boxRD1, aes(x=SET_YEAR, y=sable_wt)) + 
          geom_boxplot() +
          xlab("Year") +      ylab("sablefish kg") +
          scale_y_continuous(limits=c(0,5))+
          theme(axis.text = element_text(size = 4)) +   theme_bw()
    
    pRD2 <- ggplot(boxRD2, aes(x=SET_YEAR, y=sable_cpue)) + 
          geom_boxplot() +
          xlab("Year") +    ylab("CPUE (kg/trap)") +
          scale_y_continuous(limits=c(0,90))+
          theme(axis.text = element_text(size = 4)) +   theme_bw()
    pRD2c<- ggplot(boxRD2, aes(x=SET_YEAR, y=sable_cnts)) + 
          geom_boxplot() +
          xlab("Year") +    ylab("CPUE (#/trap)") +
          scale_y_continuous(limits=c(0,60))+
          theme(axis.text = element_text(size = 4)) +   theme_bw()
    pRD2wt<- ggplot(boxRD2, aes(x=SET_YEAR, y=sable_wt)) + 
          geom_boxplot() +
          xlab("Year") +      ylab("sablefish kg") +
          scale_y_continuous(limits=c(0,5))+
          theme(axis.text = element_text(size = 4)) +   theme_bw()  
    
    pRD3 <- ggplot(boxRD3, aes(x=SET_YEAR, y=sable_cpue)) + 
          geom_boxplot() +
          xlab("Year") +     ylab("CPUE (kg/trap)") +
          scale_y_continuous(limits=c(0,90))+
          theme(axis.text = element_text(size = 4)) +   theme_bw()
    pRD3c<- ggplot(boxRD3, aes(x=SET_YEAR, y=sable_cnts)) + 
          geom_boxplot() +
          xlab("Year") +     ylab("CPUE (#/trap)") +
          scale_y_continuous(limits=c(0,60))+
          theme(axis.text = element_text(size = 4)) +   theme_bw() 
    pRD3wt<- ggplot(boxRD3, aes(x=SET_YEAR, y=sable_wt)) + 
          geom_boxplot() +
          xlab("Year") +      ylab("sablefish kg") +
          scale_y_continuous(limits=c(0,5))+
          theme(axis.text = element_text(size = 4)) +   theme_bw()
...
```{r figure6, fig.cap='(ref:figure6)', results='asis',echo=FALSE,fig.height = 6, fig.width = 7,  fig.align = "center"}
     ...
     png("C:/github/surveyreport/figures/Figure_6_CPUES1S5.png", width=468, height=600) # write png to file
     par(mfcol=c(1,1))
...
(ref:figure7) Average number of sablefish per trap (mean +/- 95% CIs) by survey strata over time. Panels run shallow to deep (left to right) and south to north (top to bottom).

```{r figure7, fig.cap='(ref:figure7)', results='asis',echo=FALSE,fig.height = 6, fig.width = 7, fig.align = "center"}

    png("C:/github/surveyreport/figures/Figure_7_CPUE.png", width=468, height=600) # write png to file
    par(mfcol=c(1,1))
    ...
    while (!is.null(dev.list()))  dev.off()
    img <-    paste('C:/github/surveyreport/figures/Figure_7_CPUE.png',sep="")   # -- retrieve png 
              knitr::include_graphics(img)
...
```{r figure8, fig.cap='(ref:figure8)', results='asis',out.width = "450px", out.height = "550px",, fig.align = "center"}

    png("C:/github/surveyreport/figures/Figure_8_.png", width=468, height=600) # write png to file
    par(mfcol=c(1,1))
    ...
    while (!is.null(dev.list()))  dev.off()
    img <-    paste('C:/github/surveyreport/figures/Figure_8_.png',sep="")   # -- retrieve png 
              knitr::include_graphics(img)
```    
\clearpage

(ref:figure9) Sablefish catch per unit effort (CPUE) by offshore survey strata over time. Horizontal line is median and blue dots are arithmetic mean.

```{r figure9, echo=FALSE, fig.align = "center",out.width='80%'}

  png("C:/github/surveyreport/figures/Figure_9_YearStRSCPUE.png", width=600, height=800) # write png to file

  ggplot(tgc,aes(x=as.factor(SET_YEAR),y=sable_cpue))+
  ...
  while (!is.null(dev.list()))  dev.off()
    img <-    paste('C:/github/surveyreport/figures/Figure_9_YearStRSCPUE.png',sep="")   # -- retrieve png 
              knitr::include_graphics(img)

```
\clearpage

(ref:figur10) Average weight of sablefish per trap (kg/trap) at mainland Inlet localities over time (A). Average number of sablefish per trap (#fish/trap) at mainland Inlet localities over time (B).  Annual average weight of sablefish (kg) at mainland Inlets (C).
...
```{r figure11, fig.cap='(ref:figure11)',results='asis', out.width = "450px",out.height = "550px", fig.align="center"}
      ...
      png("C:/github/surveyreport/figures/Figure_11_lengths.png", width = 800, height = 924) # write png to folder
     ...
     dat       <- read.csv("c:/github/surveyreport/standaloneData/figure10_MeanLength.csv",header=T) # read from csv
...
```{r figure12, fig.cap='(ref:figure12)',results='asis', out.width = "450px",out.height = "550px", fig.align="center"}
    ...
    png("C:/github/surveyreport/figures/Figure_12_Lenwt.png", width = 800, height = 924) # -- starts writing a png to figure folder
    ...
    lenWTdat1 <- read.csv("c:/github/surveyreport/standaloneData/figure11_LengthWeight.csv",header=T) # read from csv
   ...
   img <- paste('C:/github/surveyreport/figures/Figure_12_Lenwt.png',sep="") 
          knitr::include_graphics(img)
...
# ggplot objects can be passed in ..., or to plotlist (as a list of ggplot objects)
  ...
  png("C:/github/surveyreport/figures/Figure_13_polar.png", width = 800, height = 924)  # -- starts writing a png to figure folder
 ...
 polar        <-  read.csv("c:/github/surveyreport/standaloneData/figure12_Polar.csv",header=T)        # read from csv
 ...
 sublabel  <-   (c("S1RD1","S1RD2","S1RD3",
  ...
  while (!is.null(dev.list()))  dev.off()  
    img <-   paste('C:/github/surveyreport/figures/Figure_13_polar.png',sep="")   # -- retrieve png from figures folder
             knitr::include_graphics(img)
```
\clearpage
...
```{r figure14, fig.cap='(ref:figure14)',results='asis', out.width = "450px",out.height = "570px", fig.align="center"}
   ...
   png("C:/github/surveyreport/figures/Figure_14_ages.png", width = 800, height = 924)  # -- starts writing a png to figure folder
   ...
   dat  <-  read.csv("c:/github/surveyreport/standaloneData/figure13_AgeBubblePlot.csv",header=T) # read from csv
   ...
   for (maleyr in involve){
    ...
    while (!is.null(dev.list()))  dev.off()  
    img <-   paste('C:/github/surveyreport/figures/Figure_14_ages.png',sep="")   # -- retrieve png from figures folder
             knitr::include_graphics(img)
```
\clearpage
...
```{r figure15, fig.cap='(ref:figure15)',results='asis', out.width = "500px",out.height = "600px", fig.align="center"}
   png("C:/github/surveyreport/figures/Figure_15a_coplot.png", width=920, height=424) # write png to file
      ...
      png("C:/github/surveyreport/figures/Figure_15b_coplot.png", width = 920, height = 424) # write png to file
     ...
     image_write(side_by_side, path = "C:/github/surveyreport/figures/Figure_15_coplot.png", format = "png")  # save png

     while (!is.null(dev.list()))  dev.off()
     img <-   paste('C:/github/surveyreport/figures/Figure_15_coplot.png',sep="")   # -- retrieve png 
              knitr::include_graphics(img)
...
```{r figure16, fig.cap='(ref:figure16)', results='asis', out.width = "440px",out.height = "570px", fig.align = "center"}
      # table SEABIRD_ReportLinePlot created in the Sablefish.dbo.Build_Seabird_tables procedure
       ...
       png("C:/github/surveyreport/figures/Figure_16_seabirdavg.png", width=800, height=1000) # write png to file
       ...
       while (!is.null(dev.list()))  dev.off()
       img <-   paste('C:/github/surveyreport/figures/Figure_16_seabirdavg.png',sep="")   # -- retrieve png 
                knitr::include_graphics(img)
