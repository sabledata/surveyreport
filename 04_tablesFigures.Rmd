...
```{r figure9, fig.cap='(ref:figure9)', results='asis', out.width = "600px",out.height = "800px", fig.align="center"}
...
```{r figure14, fig.cap='(ref:figure14)',results='asis', out.width = "500px",out.height = "600px", fig.align="center"}
   png("C:/github/surveyreport/figures/Figure_14a_coplot.png", width=920, height=424) # write png to file
      ...
      ctddat    <- read.csv("c:/github/surveyreport/standaloneData/figure14_SeaBirdCoplot.csv",header=T)
  ...
  # save the png
    image_write(side_by_side, path = "C:/github/surveyreport/figures/Figure_14_coplot.png", format = "png")
...
```{r figure15, fig.cap='(ref:figure15)', results='asis', out.width = "400px",out.height = "580px", fig.align="center"}
    # table SEABIRD_ReportLinePlot created in the Sablefish.dbo.Build_Seabird_tables procedure
    
       png("C:/github/surveyreport/figures/Figure_15_seabirdavg.png", width=1000, height=1050) # write png to file
       ctddt  <-  "select * from SEABIRD_ReportLinePlot"
       #ctd   <-  GetSQLData(ctddt,"Sablefish") 
       ctd    <-  read.csv("c:/github/surveyreport/standaloneData/figure15_SeaBirdLineplot.csv",header=T)
