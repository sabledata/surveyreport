...
#index -----------------------------
  ...
  write.table( trapP2, file = paste(path,"index5.csv",sep=''),row.names=FALSE, na="",col.names=TRUE,  sep=",")
  ...
  write.table( LonglineP2, file = paste(path,"index6.csv",sep=''),row.names=FALSE, na="",col.names=TRUE,  sep=",")
  ...
  write.table(strsSpCom , file = paste(path,"results4.csv",sep=''),row.names=FALSE, na="",col.names=TRUE, sep=",")
   ...
   write.table( countStRS2 , file = paste(path,"results11.csv",sep=''),row.names=FALSE, na="",col.names=TRUE, sep=",")
     ...
     write.table( lendata , file = paste(path,"results12.csv",sep=''),row.names=FALSE, na="",col.names=TRUE, sep=",")
      ...
      write.table( biosumm2 , file = paste(path,"results15.csv",sep=''),row.names=FALSE, na="",col.names=TRUE, sep=",")
      ...
      biosumm2   <-   GetSQLData(bio2,"Sablefish")
      write.table( biosumm2 , file = paste(path,"results16.csv",sep=''),row.names=FALSE, na="",col.names=TRUE, sep=",")
   ...
   write.table( agedat , file = paste(path,"results19.csv",sep=''),row.names=FALSE, na="",col.names=TRUE, sep=",")

   oldageF     <-  "exec procRReport_Survey_oldAgeFish 2"  # -- oldest female text caption
   oldageFem   <-  GetSQLData(oldageF,"Sablefish")
  write.table( oldageFem , file = paste(path,"results20.csv",sep=''),row.names=FALSE, na="",col.names=TRUE, sep=",")
   
   oldageM     <-  "exec procRReport_Survey_oldAgeFish 1"  # -- oldest male text caption
   oldageMale  <-  GetSQLData(oldageM,"Sablefish")
  write.table( oldageMale , file = paste(path,"results21.csv",sep=''),row.names=FALSE, na="",col.names=TRUE, sep=",")
     ...
     write.table(whatTraps , file = paste(path,"results22.csv",sep=''),row.names=FALSE, na="",col.names=TRUE, sep=",")

     seabrd    <-  "select * from SEABIRD_ReportLinePlot"
     seabird   <-  GetSQLData(seabrd ,"Sablefish") 
     write.table( seabird , file = paste(path,"results23.csv",sep=''),row.names=FALSE, na="",col.names=TRUE, sep=",")
