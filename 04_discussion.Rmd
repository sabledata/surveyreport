...
```{r table1, out.width = "600px", echo=FALSE, warning=FALSE, message=FALSE,comment=NA}
   ...
   kable(new)#, caption=table1)#%>%
   #kable_styling("condensed","striped",full_width = T,font_size = 11) %>%
        # column_spec(7, width = "10em")#%>%
        # scroll_box(width = "65%", height = "400px")
...
```{r table2, echo=FALSE}
   ...
   kable(trip[order(-trip$Year),])#, caption = table2) %>%
  # kable_styling(bootstrap_options = "striped","condensed", full_width = T, font_size = 10)%>%
